...
import s from './SlidersSecond.module.scss';

import btn1 from "../../../assets/images/about/arrow-left.svg";
import btn2 from "../../../assets/images/about/arrow-right.svg";
import barrels from "../../../assets/images/about/swipers/barrels.png";

export const SlidersSecond = () => {
    return (
        <section className={s.wrapper}>
            <div className={s['img-wrapper']}><img width='280' src={barrels} alt="grape" /></div>
